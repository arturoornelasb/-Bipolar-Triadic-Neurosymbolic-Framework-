...
import numpy as np
import numpy as np
# from scipy.spatial.distance import cosine # Removed dependency
...
class SemanticResonanceEngine:
    ...
    def calculate_resonance(self, A: str, B: str, C: str, D: str) -> float:
        ...
        if any(v is None for v in [va, vb, vc, vd]):
            print(f"Error: Some word does not exist in the vocabulary.")
            return 0.0
        ...
        similarity = 1 - cosine_distance(T1, T2)
        return similarity
